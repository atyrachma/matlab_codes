...
% Tugas Program Penentuan Solusi PDP Black Schole dengan Metode Crank Nicolson
% Aty Rachmawati (10108050)
disp('Program Penentuan Solusi PDP Black Schole dengan Metode Crank Nicolson')
tic
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Penentuan Solusi dengan Metode Crank Nicolson
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T1=zeros(M-1);
T1(1:2,1)=[0;-1];
T1(M-2:M-1,M-1)=[1;0];
...
p1 = k*(0.5*sigma^2 - 0.5*r)*0;
q1 = k*(0.5*sigma^2 - 0.5*r)*0;
...
% figure(1)
% mesh([0:k:T],[0:h:L],VP)
% xlabel('T-t'), ylabel('S'), zlabel('Harga Opsi Put Eropa')
% title (' Plot Harga Opsi Put Eropa terhadap S dan T-t')
% 
% figure(2)
% mesh([0:k:T],[0:h:L],VC)
% xlabel('T-t'), ylabel('S'), zlabel('Harga Opsi Call Eropa')
% title (' Plot Harga Opsi Call Eropa terhadap S dan T-t')
