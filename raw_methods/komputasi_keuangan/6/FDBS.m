...
% Tugas Program Penentuan Solusi PDP Black Schole dengan Metode Forward Difference
% Aty Rachmawati (10108050)
disp('Program Penentuan Solusi PDP Black Schole dengan Metode Forward Difference')
tic
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Penentuan Solusi dengan Metode Forward Difference
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T1=zeros(M-1);
T1(1:2,1)=[0;-1];
T1(M-2:M-1,M-1)=[1;0];
...
VP(:,i+1) = F*VP(:,i) + [p1; zeros(M-2,1)];
VC(:,i+1) = F*VC(:,i) + [p1; zeros(M-2,1)];
end
