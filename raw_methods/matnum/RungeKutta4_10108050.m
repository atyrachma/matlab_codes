...
disp('h = 0.1 ---> ukuran langkah yang dipakai')
disp(' ')
%t_iter adalah matriks 21x1 yang memuat t0 hingga t20
%x_iter adalah matriks 21x1 yang memuat x0 hingga x20
%y_iter adalah matriks 21x1 yang memuat y0 hingga y20
%t0=0, t1=1*h, ...,t20=20*h
for i=1:n
