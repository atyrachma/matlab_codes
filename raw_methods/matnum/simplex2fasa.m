...
% Sebagai contoh, jika kita mempunyai dua kendala 
...
neq=0;
red=0;
%looping kondisi berikut ini berfungsi untuk menentukan apakah suatu
%kendala perlu ditambahkan slack variable dan excess variable atau tidak
for i=1:m
    if (rel(i)=='<')
        A=[A vr(m,i)];
        les=les+1;
