% Nonlinier Least Square 
% Constant Elasticity of Substitution (CES) Production Function
% memerlukan file: f2, numgradf2, dan numgradS2
% 
...
% b=ones(4,1); % the initial values
b =[0.4;0.4;0.4;0.5] ; % change initial values of b
...
for i=1:rep;
    z=numgradf2(b,x); %Numerical gradient of f1
    zS=numgradS2(b,x,y);   %Numerical gradient of s1
