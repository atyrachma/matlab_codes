...
% memerlukan file: f1, L1, Lt1, numgradL1, dan numgradLt1
% 
...
rep = 1000 %The size of 'rep' depens on the convergence criterion and
            %the initial values
b = ones(3,1); %Initial values of b for CD Function
j1 = 0;
j2 = 0;
tn = 1.1;
...
for i = 1:rep;
    L     = L1(b,x,y);
    zt    = numgradLt1(b,x,y); %Numerical gradient, TxK
    z     = numgradL1(b,x,y); %Numerical gradient, Kx1
    step  = inv(zt'*zt)*z;
    bnext = b + step;
    Lnext  = L1(bnext,x,y);
